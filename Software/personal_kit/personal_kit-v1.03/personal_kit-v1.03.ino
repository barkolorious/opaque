...
/////////////// ESP-NOW ////////////////
typedef struct struct_message {bool alarm;} espnow_message_t;
espnow_message_t espnow_data;
esp_now_peer_info_t espnow_info;
uint8_t espnow_broadcast_addr[] = {0x5C, 0xCF, 0x7F, 0x16, 0x75, 0x9A};
////////////////////////////////// VARIABLES ///////////////////////////////////
...
void espnow_init (void) {
  ...
  memcpy(espnow_info.peer_addr, espnow_broadcast_addr, 6);
...
void espnow_update (void) {
  if (is_alarm) espnow_data.alarm = true;
  else          espnow_data.alarm = (millis() - last_alarm_time < 5000);
  esp_err_t result = esp_now_send(espnow_broadcast_addr, (uint8_t*) &espnow_data, sizeof(espnow_data));
