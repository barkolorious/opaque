...
void ssd1306_update (void) {
  ...
  ssd1306.print(pms7003_PM0p1); // PM0.1
  ...
  if (button_backup) ssd1306.fillRect(67, 2, 7, 7, 1);
  else ssd1306.drawRect(67, 2, 7, 7, 1);
  if (button_record) ssd1306.fillRect(57, 2, 7, 7, 1);
  else ssd1306.drawRect(57, 2, 7, 7, 1);
